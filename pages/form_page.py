...
class FormPage(BasePage):
    ...
    def fill_form(self):
        ...
        self.set_date_of_birth(date_of_birth.year, date_of_birth.month, date_of_birth.day)
    ...
    #     elif gender == "Female":
    #         self.element_is_visible(self.locators.GENDER_FEMALE).click()
    #     elif gender == "Other":
    #         self.element_is_visible(self.locators.GENDER_OTHER).click()
